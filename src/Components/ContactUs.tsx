...
const ContactUs = ({ ref, type = "students" }: ContactUsProps) => {
  ...
  const description =
    type === "partners"
      ...
      : "DS3 Consulting patners with companies of all sizes to tackle real-world data problems. If your organization needs help with analytics, machine learning, or data strategy, we'd love to explore how we can collaborate.";
