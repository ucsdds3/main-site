    ...
    <div style={{ width: "100%" }}>
      <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.55, ease: [0.22, 1, 0.36, 1] }} style={{ marginBottom: "2rem" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "0.6rem", marginBottom: "0.7rem" }}>
          ...
          <span style={{ fontFamily: "ui-monospace, monospace", fontSize: "0.72rem", letterSpacing: "0.22em", textTransform: "uppercase", color: "#F58134" }}>What we offer</span>
        </div>
        <h2 style={{ fontFamily: "'DM Serif Display', Georgia, serif", fontSize: "clamp(2rem, 3.4vw, 3.1rem)", fontWeight: 400, color: "var(--obs-text-primary)", margin: 0, lineHeight: 1.1 }}>Our Services</h2>
      </motion.div>
          ...
          <motion.div key={index} className="flip-card" initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: index * 0.06, ease: [0.22, 1, 0.36, 1] }}>
            <div className="flip-card-inner">
              ...
              <div className="flip-card-back">
                <span style={{ fontFamily: "ui-monospace, monospace", fontSize: "0.78rem", letterSpacing: "0.18em", textTransform: "uppercase", color: "#F58134" }}>{service.title}</span>
