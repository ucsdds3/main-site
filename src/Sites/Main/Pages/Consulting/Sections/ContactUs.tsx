...
const ContactUs = ({ ref, type = "students" }: ContactUsProps) => {
  ...
  const fieldClass =
    "w-full rounded-lg border border-[var(--obs-border,rgba(128,128,128,0.25))] bg-transparent px-[0.9rem] py-[0.65rem] text-[clamp(0.88rem,1vw,0.95rem)] text-(--obs-text-primary) outline-none transition-colors focus:border-[#F58134]";

  const labelClass =
    "mb-1.5 block font-[family-name:var(--font-mono)] text-[0.6rem] uppercase tracking-[0.18em] text-(--obs-text-primary) opacity-50";
    ...
    <div id="contact" ref={ref} className="mx-auto w-full max-w-[1300px] px-5 py-12 md:px-12 md:py-20">
      <div className="mb-8 border-b border-[var(--obs-border,rgba(128,128,128,0.2))] pb-8 md:mb-16 md:pb-12">
        ...
        <motion.h2
          ...
          className="m-0 font-[family-name:var(--font-heading)] text-[clamp(3rem,7vw,6rem)] font-normal leading-[0.95] tracking-[-0.02em] text-(--obs-text-primary)"
        >
          Contact Us
        </motion.h2>
      </div>
      ...
      <div className="grid grid-cols-1 items-start gap-12 md:grid-cols-2 md:gap-[clamp(3rem,6vw,7rem)]">
        ...
        >
          <h3 className="m-0 font-[family-name:var(--font-heading)] text-[clamp(1.4rem,2vw,1.9rem)] font-normal leading-tight text-(--obs-text-primary)">
            Want to learn more?
          </h3>
          <p className="m-0 text-[clamp(0.88rem,1.1vw,1rem)] leading-[1.75] text-(--obs-text-primary) opacity-[0.58]">
            {description}
          </p>

          <div className="mt-2 flex flex-col gap-1.5">
            <span className="font-[family-name:var(--font-mono)] text-[0.58rem] uppercase tracking-[0.18em] text-(--obs-text-primary) opacity-40">
