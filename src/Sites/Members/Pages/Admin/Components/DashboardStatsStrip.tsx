...
export default function DashboardStatsStrip() {
  ...
  return (
    <div className="flex w-full">
      <div className={`flex w-2/3 flex-wrap gap-4  ${Object.keys(stats).length}`}>
...
function StatCard({ label, value, hint, loading }: StatCardProps) {
  return (
    <div className="flex-1 min-w-[300px] rounded-2xl bg-base-300 p-5 border border-base-content/50">
