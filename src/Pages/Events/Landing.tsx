...
const Landing = ({ title, subtitle }: LandingProps) => {
  return (
    <Section className="md:flex-row justify-center md:justify-between gap-[10vh] md:gap-[5vw] w-[80vw] max-w-[1300px] min-h-[60vh] md:min-h-[70vh] py-[clamp(2rem,3vw,5rem)]">
